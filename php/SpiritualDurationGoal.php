<?php
    /**
     * SpiritualDurationGoal.php
     * This class allows the user to create spiritual duration goals
     * Author: Davis Doherty
     * Last Updated: 3/20/18 DD
     **/

    class SpiritualDurationGoal
    {
        private $numDays;       //number of days to acheive goal
        private $minutes;       //number of minutes to acheive goal
         ...
         *              $minutes->number of minutes to acheive goal
