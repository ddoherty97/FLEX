        ...
        <main>
			...
			<label for="dept">Department<sup>*</sup>: </label>
 				<select name="dept" id="dept">
					 ...
					 <option value="Applied Ethics"></option>
					 <option value="Art History"></option>
					 <option value="Asian Studies"></option>
					 <option value="Arabic"></option>
					 <option value="Biology"></option>
					 <option value="Black Studies"></option>
					 <option value="Chemistry"></option>
					 <option value="Chinese"></option>
					 <option value="Classical Studies"></option>
					 <option value="Communication"></option>
					 <option value="Economics"></option>
					 <option value="Education"></option>
					 <option value="English"></option>
					 <option value="Environmental Studies"></option>
					 <option value="Film, Television and Media Arts"></option>
					 ...
					 <option value="Humanitarian Action"></option>
					 <option value="Humanities"></option>
					 <option value="International Studies"></option>
					 <option value="Irish Studies"></option>
					 <option value="Italian"></option>
					 <option value="Japanese"></option>
					 <option value="Latin"></option>
					 <option value="Latin American and Caribbean Studies"></option>
					 ...
					 <option value="Women, Gender and Sexuality Studies"></option>
					 ...
					 <option value="Health Studies"></option>
